...
public class FloatLabelEditText extends LinearLayout {
    ...
    private void setupFloatingLabel() {
        ...
        mFloatingLabel.setTextColor(mFocusedColor);
        ...
        return new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                if (s.length() > 0
                    ...
                    showFloatingLabel();
                } else if (s.length() > 0 && mIsCustomText) {
                    setupFloatingLabel();
                    mIsCustomText = false;
                } else if (s.length() == 0
    ...
    public boolean isIsCustomText() {
        return mIsCustomText;
    }

    public void setIsCustomText(boolean mIsCustomText) {
        this.mIsCustomText = mIsCustomText;
    }
